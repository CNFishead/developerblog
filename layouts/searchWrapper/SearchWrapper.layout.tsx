...
import { Badge, Button, Dropdown, Input, Pagination, Popover, Skeleton, Space, Switch, Tooltip } from "antd";
    ...
    <div className={styles.container}>
      <div className={styles.searchContainer}>
        ...
        <div className={styles.buttonContainer}>
          ...
          {props.filters && (
            <Dropdown className={styles.button} menu={{ items: filterItems, selectable: true }} disabled={props.disableButtons}>
              <Button type="text">
                <Space>
